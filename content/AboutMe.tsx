      ...
      <div className={cn(paragraphCN, "bg-orange-400")}>
        <RevealSideways direction={1}>
          ...
          <p className="text-lg">
            ...
            Indonesia, majoring in Computer Science. I have been passionate
            about the world of Web Development since I was in junior high
            school. Fast forward a few years, I have multiple personal projects
            in Web Development and other areas of programming.
          </p>
        </RevealSideways>
      </div>
      ...
      >
        <RevealSideways direction={-1}>
          <p className="text-lg">
            ...
            challenges and new experiences, whether it is Web Development or
            other fields of Computer Science. Every opportunity is a chance for
            me to learn, improve my skills, becoming a better person, and make
